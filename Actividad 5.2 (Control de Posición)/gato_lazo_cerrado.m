...
%1 TIEMPO %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tf=140;            % Tiempo de simulación en segundos (s)
...
hxd = [0 0 3 5 5 3 2 2 4 6 8 8 10 14 16 16 15 15 13 13 12 13 11 11 11 9 9 16 16 15 13 11 9 8 8 9 9 6 6 4 3 3 5 5 1 0 0];
hyd = [8 10 13 13 12 10 10 7 9 9 7 11 9 9 11 5 6 8 8 6 6 5 5 6 8 8 6 6 5 4 3 3 4 5 2 2 0 0 4 4 3 2 2 0 0 6 8];
num_pts = length(hxd);  
...
axis([-2 18 -2 15 0 2]); % Ingresar limites minimos y maximos en los ejes x y z [minX maxX minY maxY minZ maxZ]
